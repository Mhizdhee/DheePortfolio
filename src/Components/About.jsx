...
//         <br />
//         <button
//           className="bg-[#5eb1f5] text-white border-none px-6 py-2 mt-10 w-[25%] rounded-[0.5rem] font-bold text-[18px]"
//           onClick={handleClick}
//         >
//           View CV
//         </button>
...
const About = () => {
  ...
  return (
    <div
      ...
      className="py-16 px-8 flex flex-col sm:flex-row bg-gray-100 dark:bg-gray-800 text-justify"
    >
      <div className="px-5 sm:w-1/2">
        ...
        <p className="mt-4 text-gray-700 dark:text-gray-300 max-w-2xl text-[18px] mx-auto">
          I have excellent skills in HTML, CSS, JavaScript, React,
          Bootstrap, Tailwind, Chakra UI, Material UI, GIT, and GITHUB. I derive
          satisfaction from collaborating with cross-functional teams to develop
          exceptional web applications, as I possess strong teamwork skills.
        </p>{" "}
        <br />
        ...
        <br />
        <button
          className="bg-[#5eb1f5] text-white border-none px-6 py-2 mt-10 md:w-[40%] rounded-[0.5rem] font-bold text-[18px]"
      ...
      {/* Hide image on mobile, show on tablet and larger screens */}
      <img
        className="hidden md:block w-[40%] h-[50%] p-[30px] rounded-[50%]"
        src={MyPic}
        // data-aos="flip-left"
        // data-aos-easing="ease-out-cubic"
        // data-aos-duration="2000"
